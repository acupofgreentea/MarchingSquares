...
public struct Square
{
    ...
    public Square(Vector2 position, float gridScale)
    {
        ...
        topRight = Vector2.one * (gridScale * 0.5f);
        ...
        topCenter = topRight + Vector2.left * (gridScale * 0.5f);
        rightCenter = bottomRight + Vector2.up * (gridScale * 0.5f);
        bottomCenter = bottomLeft * Vector2.right * (gridScale * 0.5f);
        leftCenter = topLeft * Vector2.down * (gridScale * 0.5f);
    }
